...
import OntologyImport from "@/components/importing/OntologyImport.vue";

const activeTab = ref<"files" | "urls">("files");
</script>

<template>
  <OntologyImport></OntologyImport>
  ...
  <!--      <OntologyImportFiles></OntologyImportFiles>-->
  <!--    </v-tabs-window-item>-->
  <!--    <v-tabs-window-item value="urls">-->
  <!--      <OntologyImportUrls></OntologyImportUrls>-->
  <!--    </v-tabs-window-item>-->
  <!--  </v-tabs-window>-->
</template>
