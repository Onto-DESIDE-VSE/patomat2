...
| `PATOMAT2_LLM_SORT_APIURL`                  | -                              | URL of the Ollama LLM service.                                                                                                                                                                                                                                   |
| `PATOMAT2_LLM_SORT_MODEL`                   |                                | Name of the LLM model in Ollama to use for LLM calls, e.g. gpt-oss:20b.                                                                                                                                                                                          |
| `PATOMAT2_LLM_SORT_BATCH_SIZE`              | 30                             | Configure maximum number of pattern instances sent to LLM in one request.                                                                                                                                                                                        |
...
| `PATOMAT2_PATTERNS`                         | `[]`                           | List of URL of sample patterns to be used by the application. Multiple patterns may be specified.                                                                                                                                                                |
